  ...
  return (
    <HelmetProvider>
      <Row>
        ...
        <div className="header services_header email_header">
        ...
        <ContentsSection id="emailMkt-contents">
          <div className="text">
            ...
            <p className="paragraph">
              Email marketing continues to be a great way for businesses to
              reach their target audience directly. Through well-planned email
              campaigns, it’s possible to increase customer retention with
              informative newsletters or product updates, or create urgent
              customer demand with exciting giveaways or promotions that feel
              like big rewards.
            </p>
            <p className="paragraph">
              ...
              precisely target the most relevant audiences and measure results
              in real time, this strategy helps you measure success and create
            ...
            <p className="paragraph">
              ...
              E-Max Interactive, our team of email marketing experts can help
              you create powerful and effective campaigns that will work for
              your business.
            </p>
            <HashLink to="#contact">
              <WaveButton>
        ...
        <PortfolioSection
          portfolio={portfolio_data
            .filter((work) => work.category.includes("Email Marketing"))
            .slice(0, 8)}
        />
        <LogoCarousel />
        <BlackBanner />
