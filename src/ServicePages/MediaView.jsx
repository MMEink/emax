      ...
      <Row>
        ...
        <ContentsSection id="media-contents">
          <div className="text">
            ...
            <p className="paragraph">
              ...
              photographs can make a lasting impression on customers, while
              video clips give an enhanced insight into what each service
              provider is offering. Images add life and color to products or
              services, and these visuals create excitement while also helping
              customers connect with the brand.
            </p>
            <p className="paragraph">
              With digital platforms like Instagram, Youtube, and TikTok
              providing access to millions of views each day, creative
              photography and video content is helping many service
              professionals rise to the top. At E-Max Interactive, we work
              closely with our clients to create meaningful visuals that help
              them stand out from the competition. We use cutting-edge
              technology to ensure that all of our photographs and videos adhere
              to the highest standards, giving your brand the edge it needs.
            </p>
            <HashLink to="#contact">
              <WaveButton>
        ...
        <PortfolioSection
          portfolio={portfolio_data
            .filter((work) => work.category.includes("Media"))
            .slice(0, 8)}
        />
        <LogoCarousel />
        <BlackBanner />
