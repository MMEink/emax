...
export default function BrandingView() {
  ...
  const block_section = services.find((s) => s.name === "Branding").blocks;
  return (
    <HelmetProvider>
      <Row>
        <Helmet>
        ...
        <div className="header services_header brand_header">
        ...
        <ContentsSection id="branding-contents">
          <div className="text">
            ...
            <p className="paragraph">
              ...
              also establishes trust and loyalty from your clientele. Branding
              can include logo design, creating a unique identity, or
              formulating a messaging and communications strategy to capture the
            ...
            <p className="paragraph">
              ...
              include logo design, brand messaging, and brand guidelines. We
              work closely with our clients to understand their unique needs and
              goals, and help create a brand that accurately represents their
              business.
            </p>
            <HashLink to="#contact">
              <WaveButton>
        ...
        <PortfolioSection
          portfolio={portfolio_data
            .filter((work) => work.category.includes("Branding"))
            .slice(0, 8)}
        />
        <LogoCarousel />
        <BlackBanner />
